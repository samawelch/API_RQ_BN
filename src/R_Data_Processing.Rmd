...
ggsave(filename = "output/images/raw/figure03_pies_RQ.svg", device = "svg", 
       width = 20, height = 10, units = "cm")

Norway_county_RQ_map

ggsave(filename = "output/images/raw/figure03_map_RQ.svg", device = "svg", 
       width = 20, height = 10, units = "cm")
...
ggsave(filename = "output/images/ready/figure04_wwtp_scenario_RQ.png", device = "png", 
       width = 20, height = 10, units = "cm")
```
...
ggsave(filename = "output/images/ready/figure05_pop_scenario_RQ.png", device = "png", 
       width = 20, height = 10, units = "cm")
```
...
ggsave(filename = "output/images/ready/figure06_combined_RQ.png", device = "png", 
