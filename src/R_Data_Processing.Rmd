...
```{r graphics theme}
# consistent_colours <- c(type = "scico", palette = "roma")
# 
# colour_scale_consistent_discrete <- function(region, begin = 0, end = 1, direction = 1) {
#     if(region == "fill") {
#         scale_fill_scico_d(palette = consistent_colours[[1]], 
#                            begin = begin, 
#                            end = end, 
#                            direction = direction)
#     }
#     if(region == "colour" | region == "color") {
#         scale_colour_scico_d(palette = consistent_colours[[1]], 
#                            begin = begin, 
#                            end = end, 
#                            direction = direction)
#     }
